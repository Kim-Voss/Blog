...
BLOG_AUTHOR = "Kim"  # (translatable)
BLOG_TITLE = "Grundstein"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.voss.kim/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.voss.kim/"
BLOG_EMAIL = "blog@voss.kim"
BLOG_DESCRIPTION = "Über Stock und Stein Gedanken wälzen."  # (translatable)
